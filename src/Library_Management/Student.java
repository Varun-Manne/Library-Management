...
public class Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbcourse.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BSc", "BBA", "B.Tech", "BA" }));
    ...
    private void btnregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregisterActionPerformed
        try {
            ...
            statement.setString(3, txtfname.getText());
            statement.setString(4, (String) cmbcourse.getSelectedItem());
            statement.setString(5, txtbranch.getText());
            statement.setString(6, (String) cmbyear.getSelectedItem());
            statement.setString(7, (String) cmbsemister.getSelectedItem());
            statement.execute();
