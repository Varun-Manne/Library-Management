...
public class Return extends javax.swing.JFrame {
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        try {
            ...
            statement.setString(1, txtsid.getText());
            result = statement.executeQuery();
            if (result.next()) {
                String add6 = result.getString("s_name");
                txtsname.setText(add6);

                String add7 = result.getString("f_name");
                txtfname.setText(add7);

                String add8 = result.getString("couresulte");
                txtcourse.setText(add8);

                String add9 = result.getString("branch");
                txtbranch.setText(add9);

                String add10 = result.getString("year");
                txtyear.setText(add10);

                String add11 = result.getString("semister");
                txtsemister.setText(add11);
                
                String add13 = result.getString("book_id");
                txtbid.setText(add13);
                
                String add1 = result.getString("b_name");
                txtbname.setText(add1);

                String add2 = result.getString("edition");
                txtedition.setText(add2);

                String add3 = result.getString("publisher");
                txtpub.setText(add3);

                String add4 = result.getString("price");
                txtprice.setText(add4);

                String add5 = result.getString("stock");
                txtstock.setText(add5);
                
                String add12 = result.getString("doi");
    ...
    public void returnUpdate(){
        String sql = "insert into returntbl(book_id, b_name, edition, publisher, price,"
                + "stock, stu_id, s_name, f_name, couresulte, branch, year, semister, doi, doreturn)"
                + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
            statement = connect.prepareStatement(sql);
            statement.setString(1, txtbid.getText());
            statement.setString(2, txtbname.getText());
            statement.setString(3, txtedition.getText());
            statement.setString(4, txtpub.getText());
            statement.setString(5, txtprice.getText());
            statement.setString(6, txtstock.getText());
            statement.setString(7, txtsid.getText());
            statement.setString(8, txtsname.getText());
            statement.setString(9, txtfname.getText());
            statement.setString(10, txtcourse.getText());
            statement.setString(11, txtbranch.getText());
            statement.setString(12, txtyear.getText());
            statement.setString(13, txtsemister.getText());
            statement.setString(14, txtdoi.getText());
            statement.setString(15, txtreturn.getText());
            statement.execute();
    ...
    public static void main(String args[]) {
        ...
        //<editor-fold defaultstate="collastatemented" desc=" Look and feel setting code (optional) ">
